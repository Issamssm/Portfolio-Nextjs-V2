...
function Footer() {
  ...
  useEffect(() => {
    fetch("https://api.github.com/repos/Issamssm/Portfolio-Nextjs-V2")
  ...
  return (
    <footer>
      <Link
        href="https://github.com/Issamssm/Portfolio-Nextjs-V2"
        target="_blank"
        className="footer-link"
      >
        <span className="footer-info">Designed and Built by Lizame issam.</span>
        {githubInfo && (
